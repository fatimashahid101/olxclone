  ...
  return(
    <Router>
      <div className="footer">
        <div className="innerFooter">
          <div className="footerLinks">
            ...
            <Link className="links">Cars</Link>
            <Link className="links">Flat</Link>
            <Link className="links">Jobs</Link>
            <Link className="links">Moble</Link>
          </div>
          <div className="footerLinks">
            <h5>TRENDING SEARCHES</h5>
            <Link className="links">Bikes</Link>
            <Link className="links">Watches</Link>
            <Link className="links">Books</Link>
            <Link className="links">Dogs</Link>
          </div>
          <div className="footerLinks">
            <h5>ABOUT US</h5>
            <Link className="links">About OLX Group</Link>
            <Link className="links">OLX Blog</Link>
            <Link className="links">Contact Us</Link>
            <Link className="links">OLX for Business</Link>
          </div>
          <div className="footerLinks">
            <h5>OLX</h5>
      ...
      <div className="copyright">
          <div className="innerCopy">
              <p><span className="bold">Other Countries</span> India - South Africa - Indonesia</p>
